...
FILES = [
    ...
    (
        'k1400000226.11-06-2026.rus.docx',
        'Уголовный кодекс РК от 03.07.2014 № 226-V (ред. 11.06.2026)',
        '%Уголовный кодекс%',
        parse_by_article,
    ),
    (
        'k1400000231.11-06-2026.rus.docx',
        'Уголовно-процессуальный кодекс РК от 04.07.2014 № 231-V (ред. 11.06.2026)',
        '%процессуальный кодекс%',
        parse_by_article,
    ),
    (
        'k1500000375.11-06-2026.rus.docx',
        'Предпринимательский кодекс РК от 29.10.2015 № 375-V (ред. 11.06.2026)',
    ...
    (
        'z100000274_.11-06-2026.rus.docx',
        'Закон РК «О защите прав потребителей» от 04.05.2010 № 274-IV (ред. 11.06.2026)',
        '%защите прав потребителей%',
        parse_by_article,
    ),
    (
        'z1500000434.11-06-2026.rus.docx',
        'Закон РК «О государственных закупках» от 04.12.2015 № 434-V (ред. 11.06.2026)',
        '%государственных закупках%',
        parse_by_article,
    ),
    (
        'v1400010250.11-06-2026.rus.docx',
        'Правила промышленной безопасности для объектов нефтяной и газовой отраслей (ред. 11.06.2026)',
        '%нефтяной и газовой%',
        parse_by_chapter,
    ),
    (
