...
def parse_and_save_to_db():
    ...
    docx_files = [
        ...
        ("k1500000414_19-05-2026_rus.docx", "Трудовой кодекс РК от 23.11.2015 № 414-V"),
        ("v2100024045_17-09-2025_rus.docx", "Технический регламент «Общие требования к пожарной безопасности»"),
        ("z1400000188_09-01-2026_rus.docx", "Закон РК «О гражданской защите» от 11.04.2014 № 188-V"),
        ("z1400000202_08-06-2026_rus.docx", "Закон РК «О разрешениях и уведомлениях» от 16.05.2014 № 202-V"),
        ("v2300033003_27-04-2026_rus.docx", "Правила дорожного движения РК"),
        ("v1500011779_25-04-2026_rus.docx", "Правила перевозки опасных грузов автомобильным транспортом"),
        ("v2100026341_06-11-2023_rus.docx", "Правила управления коммунальными отходами"),
    ]
